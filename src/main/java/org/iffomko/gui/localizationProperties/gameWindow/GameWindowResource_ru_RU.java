...
/**
 * <p>Класс, который отвечает за локализацию компоненты <code>GameWindow</code>> для русского языка/p>
 */
public class GameWindowResource_ru_RU extends ListResourceBundle {
    /**
     * <p>
