...
/**
 * <p>Класс, который отвечает за локализацию компоненты <code>RobotPositionPanel</code> для английского языка/p>
 */
public class RobotPositionPanelResource_en_US extends ListResourceBundle {
    /**
     * <p>
