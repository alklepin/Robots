...
//    }
    ...
    private JMenuBar generateMenuBar()
    {
        ...
        OptionMenu.setMnemonic(KeyEvent.VK_T);
        OptionMenu.getAccessibleContext().setAccessibleDescription(
                "Дополнительно");
        {
            JMenuItem addExitItem = new JMenuItem("Выход", KeyEvent.VK_ESCAPE);
    ...
    private void closeProgram(){
        ...
        int YesNoBox = JOptionPane.showConfirmDialog(null, "Вы уверены?");
        if (YesNoBox == 0){
            System.exit(0);
        }
    }
