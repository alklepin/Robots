 ...
 * удерживаемыми в памяти) TODO
 * 2. Этот класс хранит активные сообщения лога, но в такой реализации он их
...
public class LogWindowSource {
    ...
    public void append(LogLevel logLevel, String strMessage) {
        ...
        if (null == activeListeners) {
            synchronized (m_listeners) {
                if (null == m_activeListeners) {
    ...
    public Iterable<LogEntry> range(int startFrom, int count) {
        if (startFrom < 0 || m_messages.size() <= startFrom) {
